...
--crimes commited on 28 july 2021
--select description from crime_scene_reports where year = 2021 and month = 7 and day = 28 and street = 'Humphrey Street';-- time is 10:15

--detail from interviews where word bakery is used
--select transcript from interviews where transcript like '%bakery%';

--license plate from cars in parking
--select license_plate from bakery_security_logs where year = 2021 and month = 7 and day = 28 and hour = 10 and minute <= 25;

--check calls duration less than 60 sec
--select caller, receiver from phone_calls where year = 2021 and month = 7 and day = 28 and duration < 60;

--first flight on 29, 7, 2021 from fifthville
--origin airport id from where they will take flight
--select id from airports where city = 'Fiftyville';--8
--destination of first flight from fiftyville on 29, 7, 2021
--select id, destination_airport_id from flights where origin_airport_id = 8 and year = 2021 and month = 7 and day = 29 order by hour, minute;--flight id 36, destination 4

--select passpprt where flight id is 36
--select passport_number from passengers where flight_id = 36;

--select person in which passport, mobno, and plate is common
--select name, id from people where people.phone_number = (select caller from phone_calls where year = 2021 and month = 7 and day = 28 and duration < 60) and people.license_plate = (select license_plate from bakery_security_logs where year = 2021 and month = 7 and day = 28 and hour = 10 and minute <= 25) and people.passport_number = (select passport_number from passengers where flight_id = 36);
